...
function generateGardeningAdvice(zones: any, weatherData: any) {
  ...
  if (zones.zoneNumber <= 6) {
    ...
    recommendations.push(
      "Heat and Drought Management: With " + hotDays + " days exceeding 30 degrees Celsius annually and average rainfall of " + (avgRainfall * 365).toFixed(0) + "mm, successful gardening requires comprehensive water conservation and temperature mitigation strategies maximizing every drop while protecting plants from heat stress. " +
  ...
  if (avgRainfall < 1.5) {
    recommendations.push(
      "Water Conservation Strategies: Your annual rainfall of approximately " + (avgRainfall * 365).toFixed(0) + "mm requires comprehensive water harvesting and conservation techniques capturing every drop while selecting plants adapted to periodic drought conditions. " +
    ...
    recommendations.push(
      "Managing High Rainfall: Your abundant " + (avgRainfall * 365).toFixed(0) + "mm annual precipitation creates challenges with waterlogging, fungal diseases, and nutrient leaching requiring comprehensive drainage solutions and careful plant selection favoring moisture-tolerant species. " +
