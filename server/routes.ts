...
async function fetchClimateDataWithCoordinates(location: string, coordinates?: { latitude: number; longitude: number } | null): Promise<any> {
  ...
  try {
    ...
    return {
      ...
      avg_humidity: parseFloat(additionalMetrics.avgHumidity.toFixed(1)),
      avg_wind_speed: parseFloat(additionalMetrics.avgWindSpeed.toFixed(1)),
      ...
      wettest_month_precip: parseFloat(additionalMetrics.wettestMonthPrecip.toFixed(1)),
      driest_month: additionalMetrics.driestMonth,
      driest_month_precip: parseFloat(additionalMetrics.driestMonthPrecip.toFixed(1)),
