  ...
  return (
    <div className="min-h-screen bg-background garden-pattern">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-black/20 to-background">
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="max-w-4xl mx-auto px-8 text-center">
              <h1 className="text-3xl font-serif font-bold mb-3 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]" style={{ color: '#FFD700 !important' }}>
                {t('home.heroTitle')}
              </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        {/* Welcome Section */}
        <div className="mb-3">
          <h1 className="text-lg font-serif font-bold" style={{ color: '#FFD700' }} data-testid="text-welcome-title">
