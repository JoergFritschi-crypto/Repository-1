  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header - Compact */}
        <div className="mb-6">
          <h1 className="text-2xl font-serif font-semibold text-[#004025] mb-2 flower-band-purple rounded-lg px-6 py-3" data-testid="text-plant-library-title">
            Plant Library
          </h1>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <div className="grid lg:grid-cols-4 gap-6">
              ...
              <div className="lg:col-span-1">
                <Card className="border-2 border-[#004025]">
                  <CardHeader className="py-4 flower-band-sunset rounded-t-lg">
          ...
          <TabsContent value="collection" className="mt-8">
            <Card>
              <CardHeader className="flower-band-green rounded-t-lg">
